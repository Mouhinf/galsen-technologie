...
const orbitron = Orbitron({ subsets: ['latin'], weight: ['400', '700', '900'], variable: '--font-display', display: 'swap' });
const exo2 = Exo_2({ subsets: ['latin'], weight: ['300', '400', '600', '700'], variable: '--font-heading', display: 'swap' });
